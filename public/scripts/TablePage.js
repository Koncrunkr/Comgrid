            ...
            return function (event) {
                ...
                if (event.inputType[0] === 'i') {
                    ...
                    if (_this.text.length === 1) {
                        _this.drawer.addMessage(_this.text, _this.table.getColor(localStorage.getItem("userId")));
                    }
                }
...
var CellUnionTopic_1 = require("../../util/websocket/CellUnionTopic");
var MessageTopic_1 = require("../../util/websocket/MessageTopic");
var Table = /** @class */ (function () {
    function Table(_store) {
        ...
        _a = this.setWebsocketSubscriptions(), this.messageTopic = _a[0], this.userTopic = _a[1], this.cellUnionTopic = _a[2];
    ...
    Table.prototype.setWebsocketSubscriptions = function () {
        var _this = this;
        var tableId = parseInt((0, Util_1.getParam)('id'));
        var tableReceiveTopic = new MessageTopic_1.MessageTopic(tableId);
        this.websocket.subscribe(tableReceiveTopic, function (message) {
            if (message.senderId !== localStorage.getItem("userId"))
                _this.cells[message.x][message.y].addMessage(message.text, message.senderId);
        });
        var cellUnionReceiveTopic = new CellUnionTopic_1.CellUnionTopic(tableId);
        this.websocket.subscribe(cellUnionReceiveTopic, function (message) {
            _this.createUnion(message);
        });
        var userTopic = new UserTopic_1.UserTopic(localStorage.getItem("userId"));
        this.websocket.subscribe(userTopic, function (message) { return console.log(message); });
    ...
    Table.prototype.selectDown = function () {
        ...
        var union = this.getUnionByArr(clone);
        this.websocket.sendMessage(this.cellUnionTopic, union);
    };
    Table.prototype.getUnionByArr = function (array) {
        return {
            chatId: this._store.id,
            xcoordLeftTop: array.reduce(function (result, current) { return current.x < result ? current.x : result; }, array[0].x),
            ycoordLeftTop: array.reduce(function (result, current) { return current.y < result ? current.y : result; }, array[0].y),
            xcoordRightBottom: array.reduce(function (result, current) { return current.x > result ? current.x : result; }, array[0].x),
            ycoordRightBottom: array.reduce(function (result, current) { return current.y > result ? current.y : result; }, array[0].y)
        };
    };
    ...
    Table.prototype.pushAction = function (action) {
        ...
        if ((action[0] === Action_1.ActionType.write ||
            action[0] === Action_1.ActionType.writeWithSpace ||
            action[0] === Action_1.ActionType.delete) && this.cells[action[1]][action[2]].text !== '') {
            this.websocket.sendMessage(this.messageTopic, {
                x: action[1],
                y: action[2],
                chatId: parseInt((0, Util_1.getParam)("id")),
...
exports.Table = Table;
},{"../../util/HttpClient":8,"../../util/Util":9,"../../util/WebSocketClient":10,"../../util/request/AddParticipantRequest":11,"../../util/websocket/CellUnionTopic":16,"../../util/websocket/MessageTopic":17,"../../util/websocket/UserTopic":19,"../cell/Cell":1,"../utilities/Action":6,"./TableMod":4,"./TablePage":5}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var Util_1 = require("../../util/Util");
var CellUnionsRequest_1 = require("../../util/request/CellUnionsRequest");
var table;
...
function loadTableUnions() {
    var chatId = parseInt((0, Util_1.getParam)('id'));
    return httpClient.proceedRequest(new CellUnionsRequest_1.CellUnionsRequest({
        chatId: chatId,
        xcoordLeftTop: 0,
        ycoordLeftTop: 0,
        xcoordRightBottom: exports.store.width - 1,
        ...
        exports.store.cellsUnions = messages;
    });
}
function drawParticipants() {
    ...
    exports.store.participants.forEach(function (user) {
        var $user = $('.user-card').clone();
...
},{"../../util/HttpClient":8,"../../util/Util":9,"../../util/request/CellUnionsRequest":12,"../../util/request/IsLoggedInRequest":13,"../../util/request/TableInfoRequest":14,"../../util/request/TableMessagesRequest":15,"./Table":3}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var WebSocketClient = /** @class */ (function () {
    ...
    WebSocketClient.prototype.subscribe = function (topic, onMessage) {
        ...
        if (this.stompClient.connected) {
            this.stompClient.subscribe(topic.receiveDestination(), function (message) {
            ...
            this.subscribers.push(function () {
                _this.stompClient.subscribe(topic.receiveDestination(), function (message) {
                    var str = new TextDecoder().decode(message.binaryBody);
                    onMessage(topic.proceedMessage(str));
                });
            });
...
},{"@stomp/stompjs":20,"sockjs-client":25}],11:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CellUnionsRequest = exports.UnionResponse = void 0;
var HttpClient_1 = require("../HttpClient");
var UnionResponse = /** @class */ (function () {
    function UnionResponse() {
    }
    return UnionResponse;
}());
exports.UnionResponse = UnionResponse;
var CellUnionsRequest = /** @class */ (function () {
    function CellUnionsRequest(body) {
    ...
    CellUnionsRequest.prototype.proceedRequest = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var text;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return CellUnionsRequest;
}());
exports.CellUnionsRequest = CellUnionsRequest;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CellUnionTopic = exports.UnionOut = exports.UnionIn = void 0;
var Topic_1 = require("./Topic");
var UnionIn = /** @class */ (function () {
    function UnionIn() {
    }
    return UnionIn;
}());
exports.UnionIn = UnionIn;
var UnionOut = /** @class */ (function () {
    function UnionOut() {
    }
    return UnionOut;
}());
exports.UnionOut = UnionOut;
var CellUnionTopic = /** @class */ (function (_super) {
    __extends(CellUnionTopic, _super);
    function CellUnionTopic(tableId) {
        var _this = _super.call(this, "/connection/table_cell_union/{id}", "/connection/table_cell_union", tableId) || this;
        _this.tableId = tableId;
        return _this;
    }
    CellUnionTopic.prototype.proceedMessage = function (message) {
        return JSON.parse(message);
    };
    return CellUnionTopic;
}(Topic_1.Topic));
exports.CellUnionTopic = CellUnionTopic;
},{"./Topic":18}],17:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MessageTopic = exports.MessageOut = exports.MessageIn = void 0;
var Topic_1 = require("./Topic");
...
var MessageTopic = /** @class */ (function (_super) {
    __extends(MessageTopic, _super);
    function MessageTopic(tableId) {
        var _this = _super.call(this, "/connection/table_message/{id}", "/connection/table_message/edit_or_send", tableId) || this;
        _this.tableId = tableId;
        return _this;
    }
    MessageTopic.prototype.proceedMessage = function (message) {
        console.log(message);
        return JSON.parse(message);
    };
    return MessageTopic;
...
},{"./Topic":18}],18:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Topic = void 0;
var Topic = /** @class */ (function () {
    function Topic(receivePath, sendPath, identifier) {
        this.receivePath = receivePath;
        this.sendPath = sendPath;
        this.identifier = identifier;
    }
    Topic.prototype.receiveDestination = function () {
        return this.receivePath.replace("{id}", this.identifier);
    };
    Topic.prototype.sendDestination = function () {
        return this.sendPath.replace("{id}", this.identifier);
    };
    Topic.prototype.proceedMessage = function (message) {
        return undefined;
    };
    return Topic;
}());
...
},{"./Topic":18}],20:[function(require,module,exports){
...
},{"./main":38,"./transport-list":40}],26:[function(require,module,exports){
'use strict';
...
},{"./event":28,"inherits":21}],27:[function(require,module,exports){
'use strict';
...
},{"./eventtarget":29,"inherits":21}],28:[function(require,module,exports){
'use strict';
...
},{"./event":28,"inherits":21}],31:[function(require,module,exports){
'use strict';
...
},{"./utils/iframe":71}],32:[function(require,module,exports){
...
},{"./facade":31,"./info-iframe-receiver":34,"./location":37,"./utils/event":70,"./utils/iframe":71,"./utils/url":76,"_process":22,"debug":78}],33:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"./utils/object":73,"_process":22,"debug":78,"events":27,"inherits":21}],34:[function(require,module,exports){
'use strict';
...
},{"./info-ajax":33,"./transport/sender/xhr-local":61,"events":27,"inherits":21}],35:[function(require,module,exports){
...
},{"./info-iframe-receiver":34,"./transport/iframe":46,"./utils/event":70,"_process":22,"debug":78,"events":27,"inherits":21}],36:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"./info-ajax":33,"./info-iframe":35,"./transport/sender/xdr":58,"./transport/sender/xhr-cors":59,"./transport/sender/xhr-fake":60,"./transport/sender/xhr-local":61,"./utils/url":76,"_process":22,"debug":78,"events":27,"inherits":21}],37:[function(require,module,exports){
(function (global){(function (){
'use strict';
...
},{"./event/close":26,"./event/event":28,"./event/eventtarget":29,"./event/trans-message":30,"./iframe-bootstrap":32,"./info-receiver":36,"./location":37,"./shims":39,"./utils/browser":68,"./utils/escape":69,"./utils/event":70,"./utils/log":72,"./utils/object":73,"./utils/random":74,"./utils/transport":75,"./utils/url":76,"./version":77,"_process":22,"debug":78,"inherits":21,"url-parse":81}],39:[function(require,module,exports){
/* eslint-disable */
/* jscs: disable */
'use strict';
...
},{"./transport/eventsource":44,"./transport/htmlfile":45,"./transport/jsonp-polling":47,"./transport/lib/iframe-wrap":50,"./transport/websocket":62,"./transport/xdr-polling":63,"./transport/xdr-streaming":64,"./transport/xhr-polling":65,"./transport/xhr-streaming":66}],41:[function(require,module,exports){
(function (process,global){(function (){
'use strict';
...
},{"../../utils/event":70,"../../utils/url":76,"_process":22,"debug":78,"events":27,"inherits":21}],42:[function(require,module,exports){
(function (global){(function (){
...
},{"./lib/ajax-based":48,"./receiver/eventsource":53,"./sender/xhr-cors":59,"eventsource":42,"inherits":21}],45:[function(require,module,exports){
'use strict';
...
},{"./lib/ajax-based":48,"./receiver/htmlfile":54,"./sender/xhr-local":61,"inherits":21}],46:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"../utils/event":70,"../utils/iframe":71,"../utils/random":74,"../utils/url":76,"../version":77,"_process":22,"debug":78,"events":27,"inherits":21}],47:[function(require,module,exports){
(function (global){(function (){
'use strict';
...
},{"./lib/sender-receiver":52,"./receiver/jsonp":55,"./sender/jsonp":57,"inherits":21}],48:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"../../utils/url":76,"./sender-receiver":52,"_process":22,"debug":78,"inherits":21}],49:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"_process":22,"debug":78,"events":27,"inherits":21}],50:[function(require,module,exports){
(function (global){(function (){
'use strict';
...
},{"../../utils/object":73,"../iframe":46,"inherits":21}],51:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"_process":22,"debug":78,"events":27,"inherits":21}],52:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"../../utils/url":76,"./buffered-sender":49,"./polling":51,"_process":22,"debug":78,"inherits":21}],53:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"_process":22,"debug":78,"events":27,"eventsource":42,"inherits":21}],54:[function(require,module,exports){
(function (process,global){(function (){
'use strict';
...
},{"../../utils/iframe":71,"../../utils/random":74,"../../utils/url":76,"_process":22,"debug":78,"events":27,"inherits":21}],55:[function(require,module,exports){
(function (process,global){(function (){
'use strict';
...
},{"../../utils/browser":68,"../../utils/iframe":71,"../../utils/random":74,"../../utils/url":76,"_process":22,"debug":78,"events":27,"inherits":21}],56:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"_process":22,"debug":78,"events":27,"inherits":21}],57:[function(require,module,exports){
(function (process,global){(function (){
'use strict';
...
},{"../../utils/random":74,"../../utils/url":76,"_process":22,"debug":78}],58:[function(require,module,exports){
(function (process,global){(function (){
'use strict';
...
},{"../../utils/browser":68,"../../utils/event":70,"../../utils/url":76,"_process":22,"debug":78,"events":27,"inherits":21}],59:[function(require,module,exports){
'use strict';
...
},{"../driver/xhr":41,"inherits":21}],60:[function(require,module,exports){
'use strict';
...
},{"events":27,"inherits":21}],61:[function(require,module,exports){
'use strict';
...
},{"../driver/xhr":41,"inherits":21}],62:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"../utils/event":70,"../utils/url":76,"./driver/websocket":43,"_process":22,"debug":78,"events":27,"inherits":21}],63:[function(require,module,exports){
'use strict';
...
},{"./lib/ajax-based":48,"./receiver/xhr":56,"./sender/xdr":58,"./xdr-streaming":64,"inherits":21}],64:[function(require,module,exports){
'use strict';
...
},{"./lib/ajax-based":48,"./receiver/xhr":56,"./sender/xdr":58,"inherits":21}],65:[function(require,module,exports){
'use strict';
...
},{"./lib/ajax-based":48,"./receiver/xhr":56,"./sender/xhr-cors":59,"./sender/xhr-local":61,"inherits":21}],66:[function(require,module,exports){
(function (global){(function (){
'use strict';
...
},{"../utils/browser":68,"./lib/ajax-based":48,"./receiver/xhr":56,"./sender/xhr-cors":59,"./sender/xhr-local":61,"inherits":21}],67:[function(require,module,exports){
(function (global){(function (){
'use strict';
...
},{"./random":74}],71:[function(require,module,exports){
(function (process,global){(function (){
'use strict';
...
},{"./browser":68,"./event":70,"_process":22,"debug":78}],72:[function(require,module,exports){
(function (global){(function (){
'use strict';
...
},{"crypto":67}],75:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"_process":22,"debug":78}],76:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"_process":22,"debug":78,"url-parse":81}],77:[function(require,module,exports){
...
},{"./common":79,"_process":22}],79:[function(require,module,exports){
"use strict";
