...
var Cell = /** @class */ (function () {
            ...
            return function (event) {
                ...
                if (event.inputType[0] === 'i') {
                    ...
                    if (_this.text.length === 1) {
                        _this.addMessage(_this.text, localStorage.getItem("userId"), false);
                    }
                }
    ...
    Cell.prototype.addMessage = function (text, authorId, block) {
        if (block === void 0) { block = true; }
        var color = this.table.getColor(authorId);
        this.drawer.addMessage(text);
        this.addDecorWithFriends("background-color: ".concat(color, ";"));
        if (block)
            this.block();
    };
    ...
    Cell.prototype.clearWithFriends = function () {
        var _this = this;
        var id = localStorage.getItem("userId");
        this._friends.forEach(function (friend) {
            friend.addMessage("", id);
            _this.table.pushAction([Action_1.ActionType.delete, friend.x, friend.y]);
        });
    };
    return Cell;
}());
...
var GetLinkRequest_1 = require("../../util/request/GetLinkRequest");
var DeleteLinkRequest_1 = require("../../util/request/DeleteLinkRequest");
var Table = /** @class */ (function () {
    function Table(_store) {
        ...
        $('#invitation-create-button').on('click', function () { return _this.createInvitation(); });
        $('#invitation-disable-button').on('click', function () { return _this.deleteInvitation(); });
    ...
    Table.prototype.addParticipant = function () {
        this.http.proceedRequest(new AddParticipantRequest_1.AddParticipantRequest({ chatId: this._store.id, userId: $('#id-input').val().toString() }), function (code, errorText) { return alert(errorText); }).then(TablePage_1.drawParticipants);
        return false;
    };
    Table.prototype.createInvitation = function () {
        var _this = this;
        this.http.proceedRequest(new GetLinkRequest_1.GetLinkRequest({ chatId: this._store.id }), function (code, errorText) { return alert(errorText); }).then(function (response) {
            $('#invitation-link-keeper').text("https://comgrid.ru/pages/invite?code=".concat(response.code, "&chatId=").concat(_this._store.id));
        });
    };
    Table.prototype.deleteInvitation = function () {
        this.http.proceedRequest(new DeleteLinkRequest_1.DeleteLinkRequest({ chatId: this._store.id }), function (code, errorText) { return alert(errorText); }).then(function () {
    ...
    Table.prototype.createUnion = function (cellsUnion) {
        for (var i = cellsUnion.xcoordLeftTop; i <= cellsUnion.xcoordRightBottom; i++)
            for (var j = cellsUnion.ycoordLeftTop; j <= cellsUnion.ycoordRightBottom; j++)
    ...
    Table.prototype.selectDown = function (loading) {
    ...
    Table.prototype.pushAction = function (action) {
        ...
        if (((action[0] === Action_1.ActionType.write ||
            action[0] === Action_1.ActionType.writeWithSpace) && this.cells[action[1]][action[2]].text !== '') ||
    ...
    Table.prototype.showPopover = function (x, y, cell) {
        ...
        var $button3 = this._$popover.find('#clearButton');
        $button3.off('click');
...
exports.Table = Table;
},{"../../util/HttpClient":8,"../../util/Util":9,"../../util/WebSocketClient":10,"../../util/request/AddParticipantRequest":11,"../../util/request/DeleteLinkRequest":13,"../../util/request/GetLinkRequest":14,"../../util/websocket/CellUnionTopic":18,"../../util/websocket/MessageTopic":19,"../../util/websocket/UserTopic":21,"../cell/Cell":1,"../utilities/Action":6,"./TableMod":4,"./TablePage":5}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.drawParticipants = exports.store = exports.settings = void 0;
...
exports.drawParticipants = drawParticipants;
},{"../../util/HttpClient":8,"../../util/Util":9,"../../util/request/CellUnionsRequest":12,"../../util/request/IsLoggedInRequest":15,"../../util/request/TableInfoRequest":16,"../../util/request/TableMessagesRequest":17,"./Table":3}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@stomp/stompjs":22,"sockjs-client":27}],11:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
var CellUnionsRequest = /** @class */ (function () {
    function CellUnionsRequest(parameters) {
        this.endpoint = '/message/unions';
        this.headers = {
            "Content-Type": "application/json"
        };
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.DeleteLinkRequest = void 0;
var HttpClient_1 = require("../HttpClient");
var DeleteLinkRequest = /** @class */ (function () {
    function DeleteLinkRequest(parameters) {
        this.endpoint = "/table/invitation_link";
        this.headers = {
            "Content-Type": "application/json"
        };
        this.methodType = HttpClient_1.MethodType.DELETE;
        this.parameters = {
            chatId: parameters.chatId.toString()
        };
    }
    DeleteLinkRequest.prototype.proceedRequest = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, response.status];
            });
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.GetLinkRequest = exports.LinkGet = void 0;
var HttpClient_1 = require("../HttpClient");
var LinkGet = /** @class */ (function () {
    function LinkGet() {
    }
    return LinkGet;
}());
exports.LinkGet = LinkGet;
var GetLinkRequest = /** @class */ (function () {
    function GetLinkRequest(parameters) {
        this.endpoint = "/table/invitation_link";
        this.headers = {
            "Content-Type": "application/json"
        };
    ...
    GetLinkRequest.prototype.proceedRequest = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var text;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
},{"../HttpClient":8}],17:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"../HttpClient":8}],18:[function(require,module,exports){
"use strict";
...
},{"./Topic":20}],19:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"./Topic":20}],20:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Topic":20}],22:[function(require,module,exports){
...
},{"./event":30,"inherits":23}],29:[function(require,module,exports){
'use strict';
...
},{"./eventtarget":31,"inherits":23}],30:[function(require,module,exports){
'use strict';
...
},{"./event":30,"inherits":23}],33:[function(require,module,exports){
'use strict';
...
},{"./utils/iframe":73}],34:[function(require,module,exports){
...
},{"./facade":33,"./info-iframe-receiver":36,"./location":39,"./utils/event":72,"./utils/iframe":73,"./utils/url":78,"_process":24,"debug":80}],35:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"./utils/object":75,"_process":24,"debug":80,"events":29,"inherits":23}],36:[function(require,module,exports){
'use strict';
...
},{"./info-ajax":35,"./transport/sender/xhr-local":63,"events":29,"inherits":23}],37:[function(require,module,exports){
...
},{"./info-iframe-receiver":36,"./transport/iframe":48,"./utils/event":72,"_process":24,"debug":80,"events":29,"inherits":23}],38:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"./info-ajax":35,"./info-iframe":37,"./transport/sender/xdr":60,"./transport/sender/xhr-cors":61,"./transport/sender/xhr-fake":62,"./transport/sender/xhr-local":63,"./utils/url":78,"_process":24,"debug":80,"events":29,"inherits":23}],39:[function(require,module,exports){
(function (global){(function (){
'use strict';
...
},{"../../utils/event":72,"../../utils/url":78,"_process":24,"debug":80,"events":29,"inherits":23}],44:[function(require,module,exports){
(function (global){(function (){
...
},{"./lib/ajax-based":50,"./receiver/eventsource":55,"./sender/xhr-cors":61,"eventsource":44,"inherits":23}],47:[function(require,module,exports){
'use strict';
...
},{"./lib/ajax-based":50,"./receiver/htmlfile":56,"./sender/xhr-local":63,"inherits":23}],48:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"../utils/event":72,"../utils/iframe":73,"../utils/random":76,"../utils/url":78,"../version":79,"_process":24,"debug":80,"events":29,"inherits":23}],49:[function(require,module,exports){
(function (global){(function (){
'use strict';
...
},{"./lib/sender-receiver":54,"./receiver/jsonp":57,"./sender/jsonp":59,"inherits":23}],50:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"../../utils/url":78,"./sender-receiver":54,"_process":24,"debug":80,"inherits":23}],51:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"_process":24,"debug":80,"events":29,"inherits":23}],52:[function(require,module,exports){
(function (global){(function (){
'use strict';
...
},{"../../utils/object":75,"../iframe":48,"inherits":23}],53:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"_process":24,"debug":80,"events":29,"inherits":23}],54:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"../../utils/url":78,"./buffered-sender":51,"./polling":53,"_process":24,"debug":80,"inherits":23}],55:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"_process":24,"debug":80,"events":29,"eventsource":44,"inherits":23}],56:[function(require,module,exports){
(function (process,global){(function (){
'use strict';
...
},{"../../utils/iframe":73,"../../utils/random":76,"../../utils/url":78,"_process":24,"debug":80,"events":29,"inherits":23}],57:[function(require,module,exports){
(function (process,global){(function (){
'use strict';
...
},{"../../utils/browser":70,"../../utils/iframe":73,"../../utils/random":76,"../../utils/url":78,"_process":24,"debug":80,"events":29,"inherits":23}],58:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"_process":24,"debug":80,"events":29,"inherits":23}],59:[function(require,module,exports){
(function (process,global){(function (){
'use strict';
...
},{"../../utils/random":76,"../../utils/url":78,"_process":24,"debug":80}],60:[function(require,module,exports){
(function (process,global){(function (){
'use strict';
...
},{"../../utils/browser":70,"../../utils/event":72,"../../utils/url":78,"_process":24,"debug":80,"events":29,"inherits":23}],61:[function(require,module,exports){
'use strict';
...
},{"../driver/xhr":43,"inherits":23}],62:[function(require,module,exports){
'use strict';
...
},{"events":29,"inherits":23}],63:[function(require,module,exports){
'use strict';
...
},{"../driver/xhr":43,"inherits":23}],64:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"../utils/event":72,"../utils/url":78,"./driver/websocket":45,"_process":24,"debug":80,"events":29,"inherits":23}],65:[function(require,module,exports){
'use strict';
...
},{"./lib/ajax-based":50,"./receiver/xhr":58,"./sender/xdr":60,"./xdr-streaming":66,"inherits":23}],66:[function(require,module,exports){
'use strict';
...
},{"./lib/ajax-based":50,"./receiver/xhr":58,"./sender/xdr":60,"inherits":23}],67:[function(require,module,exports){
'use strict';
...
},{"./lib/ajax-based":50,"./receiver/xhr":58,"./sender/xhr-cors":61,"./sender/xhr-local":63,"inherits":23}],68:[function(require,module,exports){
(function (global){(function (){
'use strict';
...
},{"../utils/browser":70,"./lib/ajax-based":50,"./receiver/xhr":58,"./sender/xhr-cors":61,"./sender/xhr-local":63,"inherits":23}],69:[function(require,module,exports){
(function (global){(function (){
'use strict';
...
},{"./browser":70,"./event":72,"_process":24,"debug":80}],74:[function(require,module,exports){
(function (global){(function (){
'use strict';
...
},{"_process":24,"debug":80}],78:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"_process":24,"debug":80,"url-parse":83}],79:[function(require,module,exports){
...
},{"./common":81,"_process":24}],81:[function(require,module,exports){
"use strict";
