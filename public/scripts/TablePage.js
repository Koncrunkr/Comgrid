        ...
        get: function () {
            ...
            return function (event) {
                ...
                if (event.inputType[0] === 'i') {
                    ...
                    if (_this.isEmpty()) {
                        _this.addMessage('', headerScript_1.info.userId);
                    }
                }
