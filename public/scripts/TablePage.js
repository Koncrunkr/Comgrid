            ...
            return function (event) {
                ...
                if (event.inputType[0] === 'i') {
                    ...
                    if (_this.text.length === 1) {
                        _this.addMessage(_this.text, (0, headerScript_1.getUserId)());
                        _this.blockNo();
                    }
                }
