    ...
    WebSocketClient.prototype.subscribe = function (topic, onMessage) {
        ...
        if (this.stompClient.active) {
            ...
            this.stompClient.onConnect = function (frame) {
                _this.stompClient.onConnect(frame);
