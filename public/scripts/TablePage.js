            ...
            return function (event) {
                ...
                if (event.inputType[0] === 'i') {
                    ...
                    if (_this.text.length === 1) {
                        _this.drawer.addMessage(_this.text, _this.table.getColor((0, headerScript_1.getUserId)()));
                    }
                }
