...
var Table = /** @class */ (function () {
    ...
    Table.prototype.addParticipant = function (id) {
        this.http.proceedRequest(new this.addParticipant(id), function (code, errorText) { return alert(errorText); }).then(function () { return alert("succeed"); });
    };
