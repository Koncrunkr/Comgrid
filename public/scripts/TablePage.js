...
var Table = /** @class */ (function () {
    function Table(_store) {
        ...
        _a = this.setWebsocketSubscriptions(), this.tableTopic = _a[0], this.userTopic = _a[1];
    ...
    Table.prototype.setWebsocketSubscriptions = function () {
        var _this = this;
        var tableTopic = new TableTopic_1.TableTopic(parseInt((0, Util_1.getParam)('id')));
        ...
        this.websocket.subscribe(this.userTopic, function (message) { return console.log(message); });
...
exports.Table = Table;
},{"../../util/HttpClient":8,"../../util/Util":9,"../../util/WebSocketClient":10,"../../util/request/AddParticipantRequest":11,"../../util/websocket/TableTopic":15,"../../util/websocket/UserTopic":17,"../cell/Cell":1,"../utilities/Action":6,"./TableMod":4,"./TablePage":5}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
