...
var Table = /** @class */ (function () {
    function Table(_store) {
        ...
        $('#add-to-table-form').on('submit', function () { return _this.addParticipant($('#id-input').text()); });
    ...
    Table.prototype.addParticipant = function (id) {
        this.http.proceedRequest(new AddParticipantRequest_1.AddParticipantRequest({ chatId: this._store.id, userId: id }), function (code, errorText) { return alert(errorText); }).then(function () { return alert("succeed"); });
    };
